...
import 'business_bookings_model.dart';
export 'business_bookings_model.dart';
...
class _BusinessBookingsWidgetState extends State<BusinessBookingsWidget> {
  late BusinessBookingsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BusinessBookingsModel());
            ...
            children: [
              ...
              wrapWithModel(
                ...
                child: const ContentHeaderWidget(
                  title: 'Bookings',
                  subtitle: 'View all your client bookings',
                ),
              ),
              Container(
                width: double.infinity,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Builder(
                      builder: (context) {
                        final bookings = FFAppState().businessBookings.toList();
                        ...
                        return Column(
                          ...
                          children:
                            ...
                            return wrapWithModel(
                              model: _model.bookingCardModels.getModel(
                                bookingsIndex.toString(),
                                bookingsIndex,
                              ),
                              updateCallback: () => safeSetState(() {}),
                              child: BookingCardWidget(
                                key: Key(
                                  'Keyuhv_${bookingsIndex.toString()}',
                                ),
