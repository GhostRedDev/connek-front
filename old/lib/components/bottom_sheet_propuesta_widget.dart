...
import 'bottom_sheet_propuesta_model.dart';
export 'bottom_sheet_propuesta_model.dart';

class BottomSheetPropuestaWidget extends StatefulWidget {
  const BottomSheetPropuestaWidget({super.key});

  @override
  State<BottomSheetPropuestaWidget> createState() =>
      _BottomSheetPropuestaWidgetState();
}

class _BottomSheetPropuestaWidgetState
    extends State<BottomSheetPropuestaWidget> {
  late BottomSheetPropuestaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BottomSheetPropuestaModel());
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          wrapWithModel(
                            model: _model.leadCardInfoBottomSheetModel,
                            updateCallback: () => safeSetState(() {}),
                            child: const LeadCardInfoBottomSheetWidget(),
                          ),
                          Container(
                            width: double.infinity,
                            decoration: const BoxDecoration(),
                          ...
                          InkWell(
                            ...
                            onTap: () async {
                              _model.confirm =
                                ...
                                title: 'Send Proposal?',
                                texto:
                                    'Are you sure you want to send a proposal?',
                                cancel: 'Cancel',
                                confirm: 'Confirm',
                              );
                              if (_model.confirm!) {
                                _model.newQuoteQuery =
                                    await QuoteTable().insert({
                                  'lead_id': FFAppState().activeBusinessLead.id,
                                  'service_id':
                                      FFAppState().activeBusinessLead.serviceId,
                                  'amountCents': functions.dollarsStringToCents(
                                      _model.priceTextController.text),
                                  'description':
                                      _model.descriptionTextController.text,
                                  'expiring': supaSerialize<DateTime>(
                                      functions.expiringTime(2026, 12, 31)),
                                  'paid': false,
                                  'status': 'pending',
                                });
                                await action_blocks.updateRequestAfterQuote(
                                  context,
                                  quote: _model.newQuoteQuery,
                                );

                                context.pushNamed(BusinessPageWidget.routeName);
                              } else {
