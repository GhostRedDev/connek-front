...
import 'factura_card_model.dart';
export 'factura_card_model.dart';

class FacturaCardWidget extends StatefulWidget {
  const FacturaCardWidget({super.key});

  @override
  State<FacturaCardWidget> createState() => _FacturaCardWidgetState();
}

class _FacturaCardWidgetState extends State<FacturaCardWidget> {
  late FacturaCardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FacturaCardModel());
