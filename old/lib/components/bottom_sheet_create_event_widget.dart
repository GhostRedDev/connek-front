...
import 'bottom_sheet_create_event_model.dart';
export 'bottom_sheet_create_event_model.dart';

class BottomSheetCreateEventWidget extends StatefulWidget {
  const BottomSheetCreateEventWidget({super.key});

  @override
  State<BottomSheetCreateEventWidget> createState() =>
      _BottomSheetCreateEventWidgetState();
}

class _BottomSheetCreateEventWidgetState
    extends State<BottomSheetCreateEventWidget> {
  late BottomSheetCreateEventModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BottomSheetCreateEventModel());
                                  ...
                                  SizedBox(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        hintText:
                                            '2x1 en masajes anti-estres para pareja',
                                        hintStyle: FlutterFlowTheme.of(context)
                                            .labelMedium
                                            .override(
                                              font: GoogleFonts.inter(
