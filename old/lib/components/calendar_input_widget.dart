...
import 'calendar_input_model.dart';
export 'calendar_input_model.dart';

class CalendarInputWidget extends StatefulWidget {
  const CalendarInputWidget({
    super.key,
    required this.setExpiringDate,
  });

  final Future Function(int day, int month, int year)? setExpiringDate;
...
class _CalendarInputWidgetState extends State<CalendarInputWidget> {
  late CalendarInputModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CalendarInputModel());
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => safeSetState(() {
          ...
          _model.textController2?.text = '2025';
        }));
  }
                  ...
                  Container(
                    ...
                    child: FlutterFlowDropDown<int>(
                      ...
                      onChanged: (val) async {
                        ...
                        await widget.setExpiringDate?.call(
