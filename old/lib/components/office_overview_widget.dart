...
import 'office_overview_model.dart';
export 'office_overview_model.dart';

class OfficeOverviewWidget extends StatefulWidget {
  const OfficeOverviewWidget({super.key});

  @override
  State<OfficeOverviewWidget> createState() => _OfficeOverviewWidgetState();
}

class _OfficeOverviewWidgetState extends State<OfficeOverviewWidget> {
  late OfficeOverviewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OfficeOverviewModel());
            ...
            children: [
              ...
              wrapWithModel(
                ...
                child: const ContentHeaderWidget(
                  title: '¡Hola Business!',
                  subtitle:
                      'Bienvenido a la oficina Connek, donde podrás entrenar y administrar todos tus bots.',
                ),
              ),
              Container(
                width: double.infinity,
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                      fit: BoxFit.cover,
                                      image: Image.asset(
                                        'assets/images/Interacciones_BG.png',
                                      ).image,
                                    ),
                                    boxShadow: const [
                                      BoxShadow(
                                        blurRadius: 10.0,
                                        color: Color(0x2C28FF04),
                                        offset: Offset(
                                          0.0,
                                          5.0,
                                        ),
                                      ...
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          image: DecorationImage(
                                            fit: BoxFit.cover,
                                            image: Image.asset(
                                              'assets/images/Tasas_de_exito.png',
                                            ).image,
                                          ),
                                          boxShadow: const [
                                            BoxShadow(
                                              blurRadius: 10.0,
                                              color: Color(0x2C63FF04),
                                              offset: Offset(
                                                0.0,
                                                5.0,
                                              ),
                                      ...
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          image: DecorationImage(
                                            fit: BoxFit.cover,
                                            image: Image.asset(
                                              'assets/images/Nuevos_clientes_bg.png',
                                            ).image,
                                          ),
                                          boxShadow: const [
                                            BoxShadow(
                                              blurRadius: 10.0,
                                              color: Color(0x2CFFD004),
                                              offset: Offset(
                                                0.0,
                                                5.0,
                                              ),
                      ...
                      Expanded(
                        child: SingleChildScrollView(
                          ...
                          child: Row(
                            ...
                            children: [
                              wrapWithModel(
                                model: _model.botCardModel,
                                updateCallback: () => safeSetState(() {}),
                                child: const BotCardWidget(),
                              ),
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Flexible(
                              child: Text(
                                'Mejora el servicio de atención al cliente con Greg.',
                                style: FlutterFlowTheme.of(context)
                                    .headlineMedium
                                    .override(
                                      font: GoogleFonts.outfit(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            wrapWithModel(
                              model: _model.alertsIAModel1,
                              updateCallback: () => safeSetState(() {}),
                              child: const AlertsIAWidget(),
                            ),
                            wrapWithModel(
                              model: _model.alertsIAModel2,
                              updateCallback: () => safeSetState(() {}),
                              child: const AlertsIAWidget(),
                            ),
                            wrapWithModel(
                              model: _model.alertsIAModel3,
                              updateCallback: () => safeSetState(() {}),
                              child: const AlertsIAWidget(),
                            ),
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            wrapWithModel(
                              model: _model.notificationCardAvisoModel,
                              updateCallback: () => safeSetState(() {}),
                              child: const NotificationCardAvisoWidget(),
                            ),
                            wrapWithModel(
                              model: _model.notificationCardSugerenModel,
                              updateCallback: () => safeSetState(() {}),
                              child: const NotificationCardSugerenWidget(),
                            ),
                          ].divide(const SizedBox(height: 10.0)),
                        ),
                      ),
