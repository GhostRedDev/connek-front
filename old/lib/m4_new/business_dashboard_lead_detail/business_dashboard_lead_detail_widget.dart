...
import 'business_dashboard_lead_detail_model.dart';
export 'business_dashboard_lead_detail_model.dart';

/// loadq
class BusinessDashboardLeadDetailWidget extends StatefulWidget {
  const BusinessDashboardLeadDetailWidget({
    super.key,
  ...
  static String routeName = 'BusinessDashboardLeadDetail';
  static String routePath = 'leadOLD/:leadId';

  @override
  State<BusinessDashboardLeadDetailWidget> createState() =>
      _BusinessDashboardLeadDetailWidgetState();
}

class _BusinessDashboardLeadDetailWidgetState
    extends State<BusinessDashboardLeadDetailWidget> {
  late BusinessDashboardLeadDetailModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BusinessDashboardLeadDetailModel());
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Container(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          ].divide(const SizedBox(width: 5.0)).addToStart(const SizedBox(width: 30.0)).addToEnd(const SizedBox(width: 30.0)),
                                                                        ),
                                                                      ),
                                                                  ...
                                                                  return Container(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        if (FFAppState().exampleNumberList.length !=
                                                                            (listaExampleIndex +
                                                                                1))
                                                                          Padding(
                                                                            padding: const EdgeInsetsDirectional.fromSTEB(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                                    ...
                                                    children: [
                                                      Text(
                                                        valueOrDefault<String>(
                                                          (String firstName,
                                                                  String lastName) {
                                                            return "Lead Details - from $firstName $lastName";
                                                          }(
                                                              widget
                                                                  .leadDetail!
                                                                  .clientFirstName,
                                                              widget
                                                                  .leadDetail!
                                                                  .clientLastName),
                                                          'Lead Details - from Daniel Mendoza',
                                                        ),
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                              ...
                                                              children: [
                                                                ...
                                                                Padding(
                                                                  ...
                                                                  child: Text(
                                                                    valueOrDefault<
                                                                        String>(
                                                                      functions.datetimeFormatFull(widget
                                                                          .leadDetail
                                                                          ?.createdAt
                                                                          ?.toString()),
                                                                      'Dec 10, 2024 - 7:00 PM',
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Text(
                                                                      valueOrDefault<
                                                                        ...
                                                                        }(widget.leadDetail!.clientFirstName, widget.leadDetail!.clientLastName),
                                                                        'Daniel Mendoza',
                                                                      ),
                                                                      style: FlutterFlowTheme.of(
                                                                              context)
                                                          ...
                                                          FFButtonWidget(
                                                            onPressed:
                                                              ...
                                                              await action_blocks
                                                                ...
                                                                context,
                                                                message:
                                                                    'Client profile not yet available.',
                                                              );
                                                            },
                                                            text:
                                                                'View profile',
                                                                    ...
                                                                    children: [
                                                                      Text(
                                                                        valueOrDefault<
                                                                          ...
                                                                          (String firstName,
                                                                              String lastName) {
                                                                            return "Lead Details - $firstName $lastName";
                                                                          }(widget.leadDetail!.clientFirstName, widget.leadDetail!.clientLastName),
                                                                          'Lead Details - Daniel Mendoza',
                                                                        ),
                                                                        style: FlutterFlowTheme.of(context)
                                                                            .bodyMedium
                                                                            .override(
                                              ...
                                              if (responsiveVisibility(
                                                ...
                                                wrapWithModel(
                                                  model:
                                                      _model.leadStepsBoxModel,
                                                  updateCallback: () =>
                                                      safeSetState(() {}),
                                                  child: LeadStepsBoxWidget(
                                                    steps: functions.leadSteps(
                                                        true,
                                                        widget.leadDetail!
                                                            .clientContacted,
                                                        widget.leadDetail!
                                                ...
                                                FFButtonWidget(
                                                  onPressed: () async {
                                                    _model.response =
                                                      ...
                                                      title: 'Create Quote?',
                                                      texto:
                                                          'Are you sure to create a new quote and approve the request?',
                                                      cancel: 'CANCEL',
                                                      confirm: 'OK',
                                                    );
                                                    if (_model.response ==
                                                            ...
                                                            children: [
                                                              Column(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Text(
                                                                    formatNumber(
                                                                      functions.centsStringToDollars(_model
                                                                          .quoteData!
                                                                          .amountCents
                                                                          .toString()),
                                                                      formatType:
                                                        ...
                                                        Row(
                                                          ...
                                                          children: [
                                                            ...
                                                            Text(
                                                              valueOrDefault<
                                                                  String>(
                                                                functions.dateTimeToString(_model
                                                                    .quoteData!
                                                                    .expiring!),
                                                                '2026-01-01',
                                                              ),
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text(
                                                          'Booking confirmed for ${FFAppState().businessLeadBooking.startTimeUtc?.toString()}',
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .bodyMedium
                                                              .override(
                                                                          ...
                                                                          children:
                                                                            ...
                                                                            FFButtonWidget(
                                                                              ...
                                                                              options: FFButtonOptions(
                                                                                ...
                                                                                padding: const EdgeInsetsDirectional.fromSTEB(16.0, 0.0, 16.0, 0.0),
                                                                                iconPadding: const EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 0.0, 0.0),
                                                                                color: Theme.of(context).brightness == Brightness.light ? const Color(0x1A222831) : const Color(0x1A83B4FF),
                                                                                textStyle: FlutterFlowTheme.of(context).titleSmall.override(
                                                                                      font: GoogleFonts.outfit(
                                                                                        fontWeight: FontWeight.normal,
                                                                                        fontStyle: FlutterFlowTheme.of(context).titleSmall.fontStyle,
