...
import 'employee_hire_web_model.dart';
export 'employee_hire_web_model.dart';

class EmployeeHireWebWidget extends StatefulWidget {
  const EmployeeHireWebWidget({
    super.key,
    Color? borderColor,
    Color? bgGradient1,
    Color? bgGradient2,
  ...
  @override
  State<EmployeeHireWebWidget> createState() => _EmployeeHireWebWidgetState();
}

class _EmployeeHireWebWidgetState extends State<EmployeeHireWebWidget> {
  late EmployeeHireWebModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EmployeeHireWebModel());
                      ...
                      Expanded(
                        ...
                        child: Builder(
                          builder: (context) {
                            ...
                            return Column(
                              mainAxisSize: MainAxisSize.max,
                              children: List.generate(listExampleSkills.length,
                                  (listExampleSkillsIndex) {
                                final listExampleSkillsItem =
                                    listExampleSkills[listExampleSkillsIndex];
                                return Expanded(
                                  flex: 1,
                                  child: Container(
