...
import '/m4_new/components/about_employee/about_employee_widget.dart';
import '/m4_new/components/manage_greg_mobile/manage_greg_mobile_widget.dart';
import '/flutter_flow/custom_functions.dart' as functions;
import 'package:auto_size_text/auto_size_text.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'employee_hire_mobile_model.dart';
export 'employee_hire_mobile_model.dart';

class EmployeeHireMobileWidget extends StatefulWidget {
  const EmployeeHireMobileWidget({
    super.key,
    Color? borderColor,
    Color? bgGradient1,
    Color? bgGradient2,
  ...
  final String? id;
  final EmployeesStruct? employee;

  @override
  State<EmployeeHireMobileWidget> createState() =>
      _EmployeeHireMobileWidgetState();
}

class _EmployeeHireMobileWidgetState extends State<EmployeeHireMobileWidget> {
  late EmployeeHireMobileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EmployeeHireMobileModel());
                      ...
                      Expanded(
                        ...
                        child: Text(
                          valueOrDefault<String>(
                            ...
                            'Our virtual employee is a 24/7 AI-powered assistant designed to handle customer inquiries, administrative tasks, and routine operations efficiently. It seamlessly integrates into your business, delivering reliable support and enhancing productivity without the need for traditional staffing.',
                          ),
