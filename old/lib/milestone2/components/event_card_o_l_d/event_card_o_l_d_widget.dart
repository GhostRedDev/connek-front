...
import 'event_card_o_l_d_model.dart';
export 'event_card_o_l_d_model.dart';

class EventCardOLDWidget extends StatefulWidget {
  const EventCardOLDWidget({super.key});

  @override
  State<EventCardOLDWidget> createState() => _EventCardOLDWidgetState();
}

class _EventCardOLDWidgetState extends State<EventCardOLDWidget> {
  late EventCardOLDModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EventCardOLDModel());
