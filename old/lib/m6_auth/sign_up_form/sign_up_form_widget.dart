...
class SignUpFormWidget extends StatefulWidget {
  const SignUpFormWidget({
    ...
    this.businessPageIdRedirect,
  });

  final bool? navigateToHome;
  final int? businessPageIdRedirect;
...
class _SignUpFormWidgetState extends State<SignUpFormWidget> {
  ...
  void initState() {
    ...
    _model.phoneFieldMask = MaskTextInputFormatter(mask: '(###) ###-####');
    _model.dobYearFieldTextController ??= TextEditingController();
    _model.dobYearFieldFocusNode ??= FocusNode();

    _model.dobMonthFieldTextController ??= TextEditingController();
    _model.dobMonthFieldFocusNode ??= FocusNode();

    _model.dobDayFieldTextController ??= TextEditingController();
    _model.dobDayFieldFocusNode ??= FocusNode();
                    ...
                    children: [
                      Expanded(
                        child: SizedBox(
                          width: MediaQuery.sizeOf(context).width * 1.0,
                          child: TextFormField(
                            controller: _model.dobYearFieldTextController,
                            focusNode: _model.dobYearFieldFocusNode,
                            autofocus: false,
                            textInputAction: TextInputAction.next,
                            obscureText: false,
                            decoration: InputDecoration(
                            ...
                            validator: _model
                                .dobYearFieldTextControllerValidator
                                .asValidator(context),
                            inputFormatters: [
                      ...
                      Expanded(
                        child: SizedBox(
                          width: MediaQuery.sizeOf(context).width * 1.0,
                          child: TextFormField(
                            controller: _model.dobMonthFieldTextController,
                            focusNode: _model.dobMonthFieldFocusNode,
                            autofocus: true,
                            obscureText: false,
                            decoration: InputDecoration(
                              labelStyle: FlutterFlowTheme.of(context)
                      ...
                      Expanded(
                        child: SizedBox(
                          width: MediaQuery.sizeOf(context).width * 1.0,
                          child: TextFormField(
                            controller: _model.dobDayFieldTextController,
                            focusNode: _model.dobDayFieldFocusNode,
                            autofocus: true,
                            textInputAction: TextInputAction.next,
                            obscureText: false,
                            decoration: InputDecoration(
                            ...
                            buildCounter: (context,
                                ...
                                null,
                            keyboardType: TextInputType.number,
                            validator: _model.dobDayFieldTextControllerValidator
                                .asValidator(context),
                            inputFormatters: [
                              FilteringTextInputFormatter.allow(RegExp('[0-9]'))
                            ],
