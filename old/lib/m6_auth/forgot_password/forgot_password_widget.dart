                          ...
                          Container(
                            ...
                            child: Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  0.0, 25.0, 0.0, 0.0),
                              child: Text(
                                'You will receive an email to confirm your password reset.',
                          ...
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                if (_model.emailFieldModel
                                    .textFieldTextController.text.isEmpty) {
                                ...
                                await authManager.resetPassword(
                                  ...
                                  context: context,
                                  redirectTo:
                                      "connek://connek.ca/ResetPasswordPage",
                                );
                              },
                              text: 'Send email',
                              options: FFButtonOptions(
