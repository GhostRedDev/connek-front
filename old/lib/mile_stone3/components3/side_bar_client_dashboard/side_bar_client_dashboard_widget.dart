...
import 'side_bar_client_dashboard_model.dart';
export 'side_bar_client_dashboard_model.dart';

class SideBarClientDashboardWidget extends StatefulWidget {
  const SideBarClientDashboardWidget({
    super.key,
  ...
  @override
  State<SideBarClientDashboardWidget> createState() =>
      _SideBarClientDashboardWidgetState();
}

class _SideBarClientDashboardWidgetState
    extends State<SideBarClientDashboardWidget> {
  late SideBarClientDashboardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SideBarClientDashboardModel());
                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                          ...
                          child: AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              color: () {
                                if ((widget.navSelected == 'Notifications') &&
                                    (Theme.of(context).brightness ==
                                        Brightness.light)) {
                                  return const Color(0x4C83B4FF);
                                } else if ((widget.navSelected ==
                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                          ...
                          child: AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              color: () {
                                if ((widget.navSelected == 'request') &&
                                    (Theme.of(context).brightness ==
                                        Brightness.light)) {
                                  return const Color(0x4C83B4FF);
                                } else if ((widget.navSelected == 'request') &&
                                    (Theme.of(context).brightness ==
                                        Brightness.dark)) {
                                  return const Color(0x2583B4FF);
                                } else {
                    ...
                    MouseRegion(
                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            context.goNamed(
                              ClientDashboardChatsWidget.routeName,
                              extra: <String, dynamic>{
                                kTransitionInfoKey: const TransitionInfo(
                                  hasTransition: true,
                                  transitionType: PageTransitionType.fade,
                          ...
                          child: AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              color: () {
                                if ((widget.navSelected == 'Chats') &&
                                    (Theme.of(context).brightness ==
                                        Brightness.light)) {
                                  return const Color(0x4C83B4FF);
                                } else if ((widget.navSelected == 'Chats') &&
                                    (Theme.of(context).brightness ==
                                        Brightness.dark)) {
                                  return const Color(0x2583B4FF);
                                } else {
                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                          ...
                          child: AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              color: () {
                                if ((widget.navSelected == 'Wallet') &&
                                    (Theme.of(context).brightness ==
                                        Brightness.light)) {
                                  return const Color(0x4C83B4FF);
                                } else if ((widget.navSelected == 'Wallet') &&
                                    (Theme.of(context).brightness ==
                                        Brightness.dark)) {
                                  return const Color(0x2583B4FF);
                                } else {
