...
import 'business_draft_model.dart';
export 'business_draft_model.dart';

class BusinessDraftWidget extends StatefulWidget {
  const BusinessDraftWidget({super.key});

  @override
  State<BusinessDraftWidget> createState() => _BusinessDraftWidgetState();
}

class _BusinessDraftWidgetState extends State<BusinessDraftWidget> {
  late BusinessDraftModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BusinessDraftModel());
