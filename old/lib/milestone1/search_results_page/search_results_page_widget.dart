...
class _SearchResultsPageWidgetState extends State<SearchResultsPageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.filter = SearchResultTypes.service;
      safeSetState(() {});
    });

    _model.textController ??= TextEditingController(text: widget.searchValue);
                                ...
                                children: [
                                  if (_model.filter ==
                                    ...
                                    Padding(
                                      ...
                                      child: Builder(
                                        builder: (context) {
                                          final serviceResultsParsed =
                                              FFAppState()
                                                  .normalSearchResults
                                                  .services
                                                  .toList();
                                          if (serviceResultsParsed.isEmpty) {
                                            return const Center(
                                          ...
                                          return ListView.separated(
                                            ...
                                            itemCount:
                                                serviceResultsParsed.length,
                                            separatorBuilder: (_, __) =>
                                                const SizedBox(height: 5.0),
                                            itemBuilder: (context,
                                                serviceResultsParsedIndex) {
                                              final serviceResultsParsedItem =
                                                  serviceResultsParsed[
                                                      serviceResultsParsedIndex];
                                              return Container(
                                                decoration: const BoxDecoration(),
                                                child: wrapWithModel(
                                                  ...
                                                  updateCallback: () =>
                                                      safeSetState(() {}),
                                                  child:
                                                      SearchResultServiceWidget(
                                                    key: Key(
                                                      'Keyfkd_${serviceResultsParsedIndex.toString()}',
                                                    ),
                                                    searchResultName:
                                                        serviceResultsParsedItem
                                                            .name,
