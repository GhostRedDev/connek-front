...
class ClientRequestStruct extends BaseStruct {
  ClientRequestStruct({
    int? id,
    DateTime? createdAt,
    int? clientId,
  ...
  static ClientRequestStruct fromMap(Map<String, dynamic> data) =>
      ClientRequestStruct(
  ...
  static ClientRequestStruct? maybeFromMap(dynamic data) => data is Map
      ? ClientRequestStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static ClientRequestStruct fromSerializableMap(Map<String, dynamic> data) =>
      ClientRequestStruct(
        id: deserializeParam(
          data['id'],
          ParamType.int,
  ...
  @override
  String toString() => 'ClientRequestStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is ClientRequestStruct &&
        id == other.id &&
...
ClientRequestStruct createClientRequestStruct({
  int? id,
  DateTime? createdAt,
  int? clientId,
  String? description,
