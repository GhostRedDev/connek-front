...
class ClientRequestFullDataStruct extends BaseStruct {
  ClientRequestFullDataStruct({
    ...
    bool? bookingMade,
    int? serviceId,
    List<ClientRequestLeadDataStruct>? leads,
    int? oboBusinessId,
  })  : _id = id,
  ...
  // "leads" field.
  List<ClientRequestLeadDataStruct>? _leads;
  List<ClientRequestLeadDataStruct> get leads => _leads ?? const [];
  set leads(List<ClientRequestLeadDataStruct>? val) => _leads = val;

  void updateLeads(Function(List<ClientRequestLeadDataStruct>) updateFn) {
    updateFn(_leads ??= []);
  }
  ...
  static ClientRequestFullDataStruct fromMap(Map<String, dynamic> data) =>
      ClientRequestFullDataStruct(
        ...
        leads: getStructList(
          data['leads'],
          ClientRequestLeadDataStruct.fromMap,
        ),
        oboBusinessId: castToType<int>(data['oboBusinessId']),
      );

  static ClientRequestFullDataStruct? maybeFromMap(dynamic data) => data is Map
      ? ClientRequestFullDataStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  Map<String, dynamic> toMap() => {
        ...
        'leads': _leads?.map((e) => e.toMap()).toList(),
  ...
  static ClientRequestFullDataStruct fromSerializableMap(
      ...
      ClientRequestFullDataStruct(
        ...
        leads: deserializeStructParam<ClientRequestLeadDataStruct>(
          data['leads'],
          ParamType.DataStruct,
          true,
          structBuilder: ClientRequestLeadDataStruct.fromSerializableMap,
        ),
  ...
  @override
  String toString() => 'ClientRequestFullDataStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    const listEquality = ListEquality();
    return other is ClientRequestFullDataStruct &&
        id == other.id &&
        ...
        listEquality.equals(leads, other.leads) &&
...
ClientRequestFullDataStruct createClientRequestFullDataStruct({
  int? id,
  DateTime? createdAt,
  int? clientId,
  String? description,
