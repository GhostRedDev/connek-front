...
import '../../core/widgets/persisted_reorderable_grid.dart';
              ...
              children: [
                ...
                LayoutBuilder(
                  builder: (context, constraints) {
                    ...
                    return PersistedReorderableGrid(
                      prefsKey: 'client_support_quick_actions_order',
                      defaultOrder: const ['chat', 'call', 'email', 'report'],
                      crossAxisCount: isWide ? 4 : 2,
                      crossAxisSpacing: 16,
                      mainAxisSpacing: 16,
                      childAspectRatio: isWide ? 1.8 : 1.5,
                      itemBuilder: (context, id) {
                        return items[id] ?? const SizedBox.shrink();
                      },
                    );
                  },
                ),
