...
import '../sales/event_card_widget.dart';
          ...
          children: [
            Row(
              ...
              children: [
                ...
                IconButton(
                  icon: const Icon(ConnekIcons.close),
            ...
            SliverAppBar(
              ...
              actions: [
                Container(
                  ...
                  child: IconButton(
                    icon: const Icon(ConnekIcons.share, color: Colors.white),
                    onPressed: () {},
                  ),
                ),
                Container(
                  ...
                  child: IconButton(
                    icon: const Icon(ConnekIcons.edit, color: Colors.white),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        ElevatedButton.icon(
                          ...
                          icon: const Icon(ConnekIcons.edit, size: 16),
                          label: Text(
                            t['business_profile_edit_title'] ?? 'Editar Perfil',
                          ),
                          style: ElevatedButton.styleFrom(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Icon(
                                    _isAboutExpanded
                                        ? ConnekIcons.chevronUp
                                        : ConnekIcons.chevronDown,
                                    color: Colors.grey,
                                  ),
                                ],
                              ),
        ...
        Padding(
          ...
          child: Align(
            ...
            child: ElevatedButton.icon(
              ...
              icon: const Icon(ConnekIcons.add, size: 16),
        ...
        Padding(
          ...
          child: Align(
            ...
            child: TextButton.icon(
              onPressed: () => context.push('/business/create-portfolio'),
              icon: const Icon(ConnekIcons.photo, size: 16),
                ...
                children: [
                  CircleAvatar(
                    ...
                    child: clientImage == null
                        ? const Icon(ConnekIcons.user, size: 16)
                        : null,
                  ),
